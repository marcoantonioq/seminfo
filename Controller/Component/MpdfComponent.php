...
class MpdfComponent extends Component {
	/**
	 * Instância de classe mPDF
	 * @var object
	 */
	protected $pdf;
	/**
	 * Os valores padrão para o construtor mPDF
	 * @var array
	 */
	...
	/**
	 * Destino - valores posivel são I, D, F, S
	 * @var string
	 */
	protected $_output = 'I';
	...
	/**
	 * Initialize 
	 * Adicionar vendedor e definir classe mPDF.
	 */
	...
	/**
	 * Saindo do componente
	 * Processado, mas ainda não foi enviado para o navegador.
	 */
