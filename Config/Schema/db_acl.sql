...
CREATE TABLE IF NOT EXISTS `nucleo`.`horarios` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `horario_UNIQUE` (`inicio` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `nucleo`.`programas` (
  ...
  INDEX `fk_programas_horarios1_idx` (`horario_id` ASC),
  ...
  CONSTRAINT `fk_programas_tipoprogramas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_programas_horarios1`
...
-- -----------------------------------------------------
-- Table `nucleo`.`holdings_programas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nucleo`.`holdings_programas` ;

CREATE TABLE IF NOT EXISTS `nucleo`.`holdings_programas` (
  `id` INT(10) NOT NULL AUTO_INCREMENT,
  `holding_id` INT(10) NOT NULL,
  `programa_id` INT(10) NOT NULL,
  ...
  `updated` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_holdings_programas_programas1_idx` (`programa_id` ASC),
  INDEX `fk_holdings_programas_holdings1_idx` (`holding_id` ASC),
  CONSTRAINT `fk_holdings_programas_programas1`
    FOREIGN KEY (`programa_id`)
    REFERENCES `nucleo`.`programas` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_holdings_programas_holdings1`
    FOREIGN KEY (`holding_id`)
    REFERENCES `nucleo`.`holdings` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `nucleo`.`holdings_horarios`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nucleo`.`holdings_horarios` ;

CREATE TABLE IF NOT EXISTS `nucleo`.`holdings_horarios` (
  `id` INT NOT NULL,
  `holdings_programas_id` INT(10) NOT NULL,
  `horarios_id` INT(10) NOT NULL,
  `presenca` TINYINT(1) NULL,
  INDEX `fk_holdings_programas_horarios_horarios1_idx` (`horarios_id` ASC),
  INDEX `fk_holdings_programas_horarios_holdings_programas1_idx` (`holdings_programas_id` ASC),
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_holdings_programas_horarios_holdings_programas1`
    FOREIGN KEY (`holdings_programas_id`)
    REFERENCES `nucleo`.`holdings_programas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_holdings_programas_horarios_horarios1`
