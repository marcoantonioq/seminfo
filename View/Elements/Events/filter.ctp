<ul class="filter">
	...
	<li><?= $this->Html->link("<span class='red'>Inscrições</span>", array('controller' => 'holdings', 'action' => 'index'), array('title' => 'Consulte horários ativos ou faça sua inscrição', 'escape'=>false));  ?></li>
