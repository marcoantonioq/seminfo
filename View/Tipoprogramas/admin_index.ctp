<div class="tipoprogramas index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Visualizar'), array('action' => 'view', $tipoprograma['Tipoprograma']['id'])); ?>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Novo tipo programa'), array('action' => 'add')); ?></li>
	</ul>
</div>
