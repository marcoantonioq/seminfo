...
<h2><?php  echo __('Holdings Programa'); ?></h2>
	<dl>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Editar Holdings Programa'), array('action' => 'edit', $holdingsPrograma['HoldingsPrograma']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Holdings Programa'), array('action' => 'delete', $holdingsPrograma['HoldingsPrograma']['id']), null, __('Tem certeza de que deseja excluir # %s?', $holdingsPrograma['HoldingsPrograma']['id'])); ?> </li>
