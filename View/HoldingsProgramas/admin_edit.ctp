...
<?php echo $this->Form->create('HoldingsPrograma'); ?>
	<fieldset>
		<legend><?php echo __('Edit Holdings Programa'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('HoldingsPrograma.id')), null, __('Tem certeza de que deseja excluir # %s?', $this->Form->value('HoldingsPrograma.id'))); ?></li>
